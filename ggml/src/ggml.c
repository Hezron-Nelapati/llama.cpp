...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_NEURON_V4] = {
        .type_name                = "neuron_v4",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_v4),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_v4,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_v4_ref,
    },
    [GGML_TYPE_NEURON_V6] = {
        .type_name                = "neuron_v6",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_v6),
        .is_quantized             = true,
    ...
    [GGML_TYPE_NEURON_L4] = {
        .type_name                = "neuron_l4",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_l4),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_l4,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_l4_ref,
    },
    [GGML_TYPE_NEURON_L5] = {
        .type_name                = "neuron_l5",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_l5),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_l5,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_l5_ref,
    },
    [GGML_TYPE_NEURON_L6] = {
        .type_name                = "neuron_l6",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_l6),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_l6,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_l6_ref,
    },
    [GGML_TYPE_NEURON_D4] = {
        .type_name                = "neuron_d4",
        .blck_size                = QK_NEURON,
    ...
    [GGML_TYPE_NEURON_V5] = {
        .type_name                = "neuron_v5",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_v5),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_v5,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_v5_ref,
    },
    [GGML_TYPE_NEURON_M1] = {
        .type_name                = "neuron_m1",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m1,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m1_ref,
    },
    [GGML_TYPE_NEURON_M2] = {
        .type_name                = "neuron_m2",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m2),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m2,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m2_ref,
    },
    [GGML_TYPE_NEURON_M3] = {
        .type_name                = "neuron_m3",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m3),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m3,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m3_ref,
    },
    [GGML_TYPE_NEURON_M4] = {
        .type_name                = "neuron_m4",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m4),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m4,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m4_ref,
    },
    [GGML_TYPE_NEURON_M5] = {
        .type_name                = "neuron_m5",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m5),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m5,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m5_ref,
    },
    [GGML_TYPE_NEURON_M6] = {
        .type_name                = "neuron_m6",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m6),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m6,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m6_ref,
    },
    [GGML_TYPE_NEURON_M7] = {
        .type_name                = "neuron_m7",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m7),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m7,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m7_ref,
    },
    [GGML_TYPE_NEURON_M8] = {
        .type_name                = "neuron_m8",
        .blck_size                = QK_NEURON,
        .type_size                = sizeof(block_neuron_m8),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_neuron_m8,
        .from_float_ref           = (ggml_from_float_t) quantize_row_neuron_m8_ref,
    },
    [GGML_TYPE_Q5_K] = {
        .type_name                = "q5_K",
        .blck_size                = QK_K,
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_NEURON_V4:     wtype = GGML_TYPE_NEURON_V4; break;
        case GGML_FTYPE_MOSTLY_NEURON_L4:     wtype = GGML_TYPE_NEURON_L4; break;
        case GGML_FTYPE_MOSTLY_NEURON_L5:     wtype = GGML_TYPE_NEURON_L5; break;
        case GGML_FTYPE_MOSTLY_NEURON_L6:     wtype = GGML_TYPE_NEURON_L6; break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_NEURON_L4: result = quantize_neuron_l4(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_NEURON_L5: result = quantize_neuron_l5(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_NEURON_L6: result = quantize_neuron_l6(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        ...
        case GGML_TYPE_NEURON_M3: result = quantize_neuron_m3(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_NEURON_M4: result = quantize_neuron_m4(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_NEURON_M5: result = quantize_neuron_m5(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_NEURON_M6: result = quantize_neuron_m6(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_NEURON_M7: result = quantize_neuron_m7(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_NEURON_M8: result = quantize_neuron_m8(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
