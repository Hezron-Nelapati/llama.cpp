...
template [[host_name("kernel_mul_mm_neuron_m1_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m1, QK_NEURON/16, dequantize_neuron_m1, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_m2_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m2, QK_NEURON/16, dequantize_neuron_m2, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_m3_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m3, QK_NEURON/16, dequantize_neuron_m3, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_m4_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m4, QK_NEURON/16, dequantize_neuron_m4, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_m5_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m5, QK_NEURON/16, dequantize_neuron_m5, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_m6_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m6, QK_NEURON/16, dequantize_neuron_m6, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_m7_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m7, QK_NEURON/16, dequantize_neuron_m7, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_m8_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_m8, QK_NEURON/16, dequantize_neuron_m8, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_v4_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_v4, QK_NEURON/16, dequantize_neuron_v4, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_v6_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_v6, QK_NEURON/16, dequantize_neuron_v6, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_v5_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_v5, QK_NEURON/16, dequantize_neuron_v5, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_l4_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_l4, QK_NEURON/16, dequantize_neuron_l4, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_l5_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_l5, QK_NEURON/16, dequantize_neuron_l5, float, float4x4, float, float2x4>;
template [[host_name("kernel_mul_mm_neuron_l6_f32")]] kernel mul_mm_t kernel_mul_mm<half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_neuron_l6, QK_NEURON/16, dequantize_neuron_l6, float, float4x4, float, float2x4>;
